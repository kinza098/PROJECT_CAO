...
c: .asciiz "______________________COMPUTER ARCHITECTURE AND ORGANIZATION CEN -221  PROJECT_____________________\n"
APP:.asciiz "PROJECT:____________________INTEGERS SEARCHING AND SORTING APPLICATION______________________\n\n"
GM:.asciiz "-----------------------GROUP MEMBERS--------------------------\n"
GM1: .asciiz "1. IQRA AFZAAL (02-131192-048)\n"
GM2: .asciiz "2. KINZA NOOR (02-131192-025)\n"
GM3: .asciiz "3. FIZZAH MUKHTAR (02-131192-042)\n"
GM4: .asciiz "4. AQSA SHAMSHER (02-131192-033)\n\n"
M: .asciiz "Dear User! Do you want to store data in Collection?\n_____Enter 1 if you want or 0 if you don't want to store:\n"
nd: .asciiz "\n****************HAVE A NICE DAY! :)********************"
st: .asciiz "YOUR DATA HAS BEEN SUCCESSFULLY STORED!!!\n"
so: .asciiz "\nSorted Collection of Numbers is given below!\n"
se: .asciiz "Do you want to search any element in your collection?\n______Enter 1 if you want or 0 if you don't want to search any element:\t"
.text
.globl main
main:
li $v0, 4
